...
namespace Checkmarx.API.AST.Services.Audit
{
    ...
    public partial class Audit
    {
        ...
        public Audit(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// - The `from` date cannot be more than 365 days in the past.
        ...
        /// </remarks>
        /// <param name="from">Start date for the event filter in `YYYY-MM-DD` format. Cannot be more than 365 days in the past.</param>
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>
        /// Downloads the JSON content from a temporary audit link URL.
        /// </summary>
        /// <param name="url">Temporary download URL obtained from an <see cref="AuditLink"/>.</param>
        /// <returns>Raw JSON string of the daily audit events file.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<string> DownloadLinkAsync(string url, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            using (var dataStream = await response_.Content.ReadAsStreamAsync().ConfigureAwait(false))
    ...
    {
        /// <summary>
        /// Links to JSON files containing audit events for previous days (non-current day).
        /// Each link is temporary and valid for 1 hour.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("links", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<AuditLink> Links { get; set; }

        /// <summary>
        /// List of audit events for the current day
        /// </summary>
        ...
        public System.Collections.Generic.ICollection<AuditEvent> Events { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v12.0.0.0))")]
    public partial class AuditLink
    {
        /// <summary>
        /// Date of the archived audit events
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("crc", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class AuditEvent
    {
        ...
        /// <summary>
        /// Type/category of the audit event
        /// </summary>
        ...
        /// <summary>
        /// Name or identifier of the audited resource
        /// </summary>
        [Newtonsoft.Json.JsonProperty("auditResource", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string AuditResource { get; set; }

        /// <summary>
        /// Type of action performed (e.g., LOGIN, CREATE, UPDATE)
        /// </summary>
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("actionUserId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
